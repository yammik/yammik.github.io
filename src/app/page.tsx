...
export default function Home() {
  ...
  return (
    <main className="w-2/3 p-12 pt-0 flex justify-between">
      <div className="h-[calc(100dvh-20rem)] leading-8 flex flex-col gap-y-20 overflow-scroll no-scrollbar z-1">
        <div id="about">
      ...
      <div>
        <div className="fixed bottom-0 right-[10%] w-[22rem] h-[22rem] bg-lime-700 z-0"></div>
      </div>
    </main>
  );
}
